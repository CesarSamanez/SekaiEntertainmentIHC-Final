     ...
     <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search" title="Type in a name">
        ...
        <div class="box-body table-responsive no-padding">
           <table id="myTable" class="table table-bordered table-striped">
            ...
            <?= __('Editing purchase') ?> <input id="id" name="id" value="<?= $purchase->id ?>" readonly>
           ...
           <?php 
               ...
               $quantity=0;
                ?>
           <td><?= __('Quantity') ?><input type="number" id="cant" value="<?= $quantity ?>" name="cantidad" readonly></td>
           <td><?= __('Total') ?><input type="number" id="total" value="<?= $total ?>" name="total" readonly></td>
           </tbody>
           </table>
           <input type="submit" class="btn btn-success"  value="<?= __('Send') ?>" onclick="borrar()">
           </form>
        </div>
        <!-- /.box-body -->
      </div>
