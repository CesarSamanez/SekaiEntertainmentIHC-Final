...
<section class="content">
  ...
  $semanaPasada = "SELECT *FROM timba_uses WHERE initial_date >= curdate() - INTERVAL DAYOFWEEK(curdate())+6 DAY AND initial_date < curdate() - INTERVAL DAYOFWEEK(curdate())-1 DAY";
  ...
  $semanaActual= "SELECT *FROM timba_uses WHERE YEARWEEK(initial_date) = YEARWEEK(CURDATE())";
  ...
  $ultimoMes = "SELECT *FROM timba_uses WHERE initial_date BETWEEN date_sub(now(), interval 1 month) AND NOW()";
